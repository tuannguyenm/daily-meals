...
export interface Meal{id:string;type:MealType;title:string;sideDishes:string[];image:ImageSourcePropType;cookingTimeMinutes:number;estimatedCost:number;servings:number;missingIngredients:string[];status:'unconfirmed'|'confirmed'|'completed';slug?:string;summary?:string;cuisine?:string;difficulty?:'easy'|'medium'|'hard';tags?:string[];nutrition?:Record<string,unknown>}
...
export interface RecipeIngredient{id:string;name:string;quantity:string;category:string;available:boolean}
