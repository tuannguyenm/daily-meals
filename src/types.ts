...
export type MealSource='home_cooked'|'ready_made';
...
export interface Meal{id:string;type:MealType;title:string;sideDishes:string[];image:ImageSourcePropType;cookingTimeMinutes:number;estimatedCost:number;servings:number;missingIngredients:string[];status:'unconfirmed'|'confirmed'|'completed';slug?:string;summary?:string;cuisine?:string;difficulty?:'easy'|'medium'|'hard';tags?:string[];nutrition?:Partial<NutritionInfo>;mealSource?:MealSource;purchaseTimeMinutes?:number;pricePerServing?:number}
